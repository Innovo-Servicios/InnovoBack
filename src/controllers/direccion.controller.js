...
const {medidor_MongooseModel:medidor, medidor_MongooseModel} = require('../models/medidor.model.js')
const {trabajador_MongooseModel: trabajador_MongooseModel} = require('../models/trabajador.model.js')
